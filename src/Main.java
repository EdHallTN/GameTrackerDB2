...
public class Main {
    ...
    static void updateGame(Connection conn, Integer id, String name, String genre,
        ...
        Statement stmt = conn.createStatement();
        PreparedStatement stmt1 = conn.prepareStatement("UPDATE GAMES SET GAMENAME = ?, GENRE = ?, PLATFORM = ?," +
                "RELEASE_YEAR = ? WHERE ID = ?");
        stmt1.setString(1, name);
        stmt1.setString(2, genre);
        stmt1.setString(3, platform);
        stmt1.setInt(4, releaseYear);
        stmt1.setInt(5, id);
    ...
    static void insertGame(Connection conn, String name, String genre, String platform, Integer releaseYear)
            throws SQLException {
